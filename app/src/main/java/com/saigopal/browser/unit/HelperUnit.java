...
public class HelperUnit {
    ...
    public static void applyTheme(Context context) {
        ...
        String showNavButton = Objects.requireNonNull(sp.getString("sp_theme", "0"));
        ...
        try {
            ...
            builder.setPositiveButton(R.string.app_ok, (dialog, whichButton) -> {
                ...
                if (title.isEmpty() || extension1.isEmpty() || !extension1.startsWith(".")) {
                    Toasty.show(activity, activity.getString(R.string.toast_input_empty));
                } else {
    ...
    public static void setFavorite (Context context, String url) {
        ...
        Toasty.show(context, R.string.toast_fav);
    }
