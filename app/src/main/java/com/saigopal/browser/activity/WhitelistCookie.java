...
public class WhitelistCookie extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cookie = new Cookie(WhitelistCookie.this);
        ...
        adapter = new WhitelistAdapter(this, list){
            ...
            public View getView (final int position, View convertView, @NonNull ViewGroup parent) {
                ...
                whitelist_item_cancel.setOnClickListener(v1 -> {
                    ...
                    Toasty.show(WhitelistCookie.this, R.string.toast_delete_successful);
                });
                return v;
            }
        };
        ...
        button.setOnClickListener(v -> {
            ...
            if (domain.isEmpty()) {
                Toasty.show(WhitelistCookie.this, R.string.toast_input_empty);
            } else if (!BrowserUnit.isURL(domain)) {
                Toasty.show(WhitelistCookie.this, R.string.toast_invalid_domain);
            } else {
                RecordAction action1 = new RecordAction(WhitelistCookie.this);
                action1.open(true);
                if (action1.checkDomain(domain, RecordUnit.TABLE_COOKIE)) {
                    Toasty.show(WhitelistCookie.this, R.string.toast_domain_already_exists);
                } else {
                    Cookie cookie = new Cookie(WhitelistCookie.this);
                    cookie.addDomain(domain.trim());
                    list.add(0, domain.trim());
                    adapter.notifyDataSetChanged();
                    Toasty.show(WhitelistCookie.this, R.string.toast_add_whitelist_successful);
                }
                action1.close();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.menu_clear:
                dialog = new BottomSheetDialog(WhitelistCookie.this);
                dialogView = View.inflate(WhitelistCookie.this, R.layout.dialog_action, null);
            ...
            case R.id.menu_backup:
                dialog = new BottomSheetDialog(Objects.requireNonNull(WhitelistCookie.this));
                dialogView = View.inflate(WhitelistCookie.this, R.layout.dialog_action, null);
                textView = dialogView.findViewById(R.id.dialog_text);
                ...
                action_ok.setOnClickListener(view -> {
                    if (android.os.Build.VERSION.SDK_INT >= 23 && android.os.Build.VERSION.SDK_INT < 29) {
                        ...
                        if (hasWRITE_EXTERNAL_STORAGE != PackageManager.PERMISSION_GRANTED) {
                            HelperUnit.grantPermissionsStorage(WhitelistCookie.this);
                            dialog.cancel();
                        } else {
                            dialog.cancel();
                            HelperUnit.makeBackupDir(WhitelistCookie.this);
                            new ExportWhiteListTask(WhitelistCookie.this, 2).execute();
                        }
                    } else {
                        dialog.cancel();
                        HelperUnit.makeBackupDir(WhitelistCookie.this);
                ...
                action_ok.setOnClickListener(view -> {
                    if (android.os.Build.VERSION.SDK_INT >= 23 && android.os.Build.VERSION.SDK_INT < 29) {
                        ...
                        if (hasWRITE_EXTERNAL_STORAGE != PackageManager.PERMISSION_GRANTED) {
                            ...
                            dialog.cancel();
                            new ImportWhitelistTask(WhitelistCookie.this, 2,null).execute();
                        }
                    } else {
                        dialog.cancel();
                        new ImportWhitelistTask(WhitelistCookie.this, 2,null).execute();
